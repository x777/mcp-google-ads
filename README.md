...
> **About this fork:** This repository is a fork of [cohnen/mcp-google-ads](https://github.com/cohnen/mcp-google-ads) (original work by Ernesto Cohnen, MIT licensed). It is maintained for additional tooling and experiments by [x777](https://github.com/x777) (diyasrv@gmail.com). Upstream attribution is preserved throughout — see `LICENSE` for the original copyright.
...
- Mac: 
  - Python path: `/Users/YOUR-USERNAME/Documents/mcp-google-ads/.venv/bin/python`
  - Script path: `/Users/YOUR-USERNAME/Documents/mcp-google-ads/google_ads_server.py`
- Windows: 
  - Python path: `C:\\Users\\YOUR-USERNAME\\Documents\\mcp-google-ads\\.venv\\Scripts\\python.exe`
  - Script path: `C:\\Users\\YOUR-USERNAME\\Documents\\mcp-google-ads\\google_ads_server.py`
